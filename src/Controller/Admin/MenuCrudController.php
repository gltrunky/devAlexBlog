...
class MenuCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        return $this->menuRepo->getIndexQueryBuilder($this->getFiledNameFromSubMenuIndex($subMenuIndex));
    }
    ...
    private function getFiledNameFromSubMenuIndex(int $subMenuIndex): string
    {
    ...
    {
        $fieldName = $this->getFiledNameFromSubMenuIndex($subMenuIndex);
